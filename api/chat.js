  ...
  try {
    const anthropicRes = await fetch(ANTHROPIC_API_URL, {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 512,
        system: systemPrompt,
        messages: body.messages.slice(-10).map(function(m) {
    ...
    const responseText = (data.content && data.content[0] && data.content[0].text) || 'I had trouble generating a response. Try again.';
